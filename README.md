...
`rpm -Uvh --oldpackage https://github.com/AikidoSec/firewall-php/releases/download/v1.0.94/aikido-php-firewall-1.0.94-1.x86_64.rpm`

#### For Debian-based Systems (Debian, Ubuntu)

`dpkg -i https://github.com/AikidoSec/firewall-php/releases/download/v1.0.94/aikido-php-firewall-1.0.94-1.x86_64.deb`
...
commands:
  aikido-php-firewall:
    command: "rpm -Uvh --oldpackage https://github.com/AikidoSec/firewall-php/releases/download/v1.0.94/aikido-php-firewall-1.0.94-1.x86_64.rpm"
    ignoreErrors: true
